...
#    Updated: 2023/05/25 22:19:26 by zoozdev777       ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
initial =7    
def f(x, y=3, z= initial): # required param is x and is first before optional params
    print("x, y, z are "+ str(x), str(y), str(z))
    
f(2) # required is provided; output # 2, 3, 7
f(2,4) # output # 2, 4, 7
#f(2, ,8) runtime error
